...
void rt::ReflectionScene::SetupSceneObjects()
{
	...
	// ****************************************************************************
	camera_.SetPosition(qbVector3<double>{std::vector<double>{0.0, -10.0, -1.0}});
	camera_.SetLookAt(qbVector3<double>{std::vector<double>{0.0, 0.0, 0.0}});
	camera_.SetUpVector(qbVector3<double>{std::vector<double>{0.0, 0.0, 1.0}});
	...
	objectList_.at(3)->baseColor_ = qbVector3<double>{ std::vector<double>{0.5, 0.5, 0.5} };
	...
	objectList_.at(0)->baseColor_ = qbVector3<double>{ std::vector<double>{0.25, 0.5, 0.8} };
	objectList_.at(1)->baseColor_ = qbVector3<double>{ std::vector<double>{1.0, 0.5, 0.0} };
	objectList_.at(2)->baseColor_ = qbVector3<double>{ std::vector<double>{1.0, 0.8, 0.0} };
	...
	lightList_.at(0)->m_Location = qbVector3<double>{ std::vector<double>{5.0, -10.0, -5.0} }; // -z value because currently the z axis is inverted in our application.
	lightList_.at(0)->m_Color = qbVector3<double>{ std::vector<double>{0.0, 0.0, 1.0} };

	lightList_.push_back(std::make_shared<rt::PointLight>(rt::PointLight()));
	lightList_.at(1)->m_Location = qbVector3<double>{ std::vector<double>{-5.0, -10.0, -5.0} };
	lightList_.at(1)->m_Color = qbVector3<double>{ std::vector<double>{1.0, 0.0, 0.0} };

	lightList_.push_back(std::make_shared<rt::PointLight>(rt::PointLight()));
	lightList_.at(2)->m_Location = qbVector3<double>{ std::vector<double>{0.0, -10.0, -5.0} };
	lightList_.at(2)->m_Color = qbVector3<double>{ std::vector<double>{0.0, 1.0, 0.0} };
}
